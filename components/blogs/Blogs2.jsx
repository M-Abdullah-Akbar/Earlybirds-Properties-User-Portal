...
const Blogs2 = () => {
  ...
  const handleCategoryChange = (categoryId) => {
    ...
    setCurrentPage(1);
    fetchBlogs(1, categoryId, searchTerm);
  };
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    fetchBlogs(page, selectedCategory, searchTerm);
  ...
  return (
    <section id="blogs-section" className="section-blog-grid mt-5">
      <div className="tf-container">
        <div className="row">
          <div className="col-12">
            {/* Header */}
            <div className="box-title">
              <h2>Earlybirds Properties Blogs</h2>
            </div>

            {/* Filters */}
            {/*<div className="mb-4 d-flex flex-column flex-md-row gap-3 justify-content-between align-items-center">
              Search and Filter Controls
              <div className="mb-4 d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-start align-items-lg-center">
                Search Form
                <form 
                  onSubmit={handleSearch} 
                  className="d-flex gap-2 w-100 w-lg-auto" 
                ...
                >
                  <input
                    ...
                    aria-label="Search blogs by title or content"
                  />
                  <button 
                    type="submit" 
                    className="tf-btn-primary"
                ...
                <div className="d-flex gap-2 align-items-center flex-wrap">
                  <label htmlFor="category-filter" className="form-label mb-0 text-nowrap">
                    Filter by Category:
                  </label>
                  <select
                    id="category-filter"
            ...
            {loading ? (
              ...
              <ErrorMessage 
                message={error} 
                onRetry={() => fetchBlogs(currentPage, selectedCategory, searchTerm)} 
              />
            ) : blogs.length === 0 ? (
              <div className="text-center py-5">
                <div className="text-muted fs-5">No blogs found.</div>
              ...
              <>
                ...
                <div className="grid-layout-3">
                  {blogs.map((blog) => (
                    <div key={blog._id} className="blog-article-item style-2">
