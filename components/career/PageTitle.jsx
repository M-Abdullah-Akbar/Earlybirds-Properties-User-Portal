...
export default function PageTitle() {
  ...
  useEffect(() => {
    if (modelRef.current) {
      modelRef.current.style.backgroundImage =
        "url('/images/Buy-and-Rent-Properties-in-Dubai-Earlybird-Properties.jpg')";
    }
  }, []);
  ...
  return (
    <div className="page-title career" ref={modelRef}>
