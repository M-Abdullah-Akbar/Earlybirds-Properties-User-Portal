          ...
          <div className="col-lg-12">
            ...
            <div className="box-description mb-48">
              <div className="widget about">
                <h6 className="title">Your Premier Choice for Dubai Real Estate</h6>
                <p className="text-1 mb-12">
                  Welcome to Earlybird Properties, your trusted partner in the dynamic world of Dubai real estate. We stand proud as a leading real estate company with over a decade of unwavering dedication and expertise. Our mission is to provide exceptional service and innovative solutions, making buying, renting, or selling properties as seamless and enjoyable as possible.
                </p>
                <br />
                <h6 className="title">Our Story</h6>
                <p className="text-1">
                EarlyBirds Properties was founded with a vision to revolutionize the real estate market in Dubai. Over the years, we have achieved numerous milestones and established ourselves as a trusted name in the industry. Groundbreaking developments, transformative investment strategies, and a commitment to excellence mark our journey. A passion for innovation, integrity, and unparalleled insight drives us.
                </p>
              </div>
            ...
            <div className="tf-sidebar sticky-sidebar">
              ...
              <div className="sidebar-ads">
                ...
                <div className="box-ads relative z-5">
                  ...
                  <a href="/contact" className="tf-btn fw-6 bg-color-primary w-full">
