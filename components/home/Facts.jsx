...
const getIconProps = (color, bgColor, index) => {
  ...
  return (isDarkMode) => {
    ...
    const baseStyle = {
      ...
      boxShadow: isDarkMode ? "0 6px 15px rgba(255, 255, 255, 0.08)" : "0 6px 15px rgba(0, 0, 0, 0.08)",
    };
      ...
      <div className="tf-container">
        <div className="row">
          <div className="col-12">
            <div className="heading-section mb-56 gap-32" style={{ textAlign: "center" }}>
              <h2 className="title split-text effect-right fw-5" style={{ 
                marginBottom: "25px", 
                fontSize: "2.8rem",
                fontWeight: "700",
                letterSpacing: "0.5px"
            ...
            <div className="col-lg-3 col-6" key={index}>
              <div 
                ...
                style={{ 
                   ...
                   height: "100%",
                   boxShadow: isDarkMode ? "0 2px 10px rgba(255, 255, 255, 0.03)" : "0 2px 10px rgba(0, 0, 0, 0.03)",
                   cursor: "pointer",
