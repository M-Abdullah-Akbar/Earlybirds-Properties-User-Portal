                ...
                <div className="box-contact style-1 pt-0 pb-0">
                  <div className="heading-section mb-56 gap-32">
                    <h2 className="title split-text split-lines-transform">
                      Earlybird Properties Comprehensive solution for your real estate buying
                      and selling
                    </h2>
                  ...
                  <ul className="list-info">
                    <li className="animate__fadeInUp animate__animated">
                      ...
                      <div className="content">
                        ...
                        <div className="phone">+971 56 691 4193</div>
                      </div>
                    </li>
                    <li className="animate__fadeInUp animate__animated">
                      <div className="icon">
                      ...
                      <div className="content">
                        ...
                        <p>info@earlybirdproperties.com</p>
                      </div>
                    </li>
                  </ul>
                </div>
                        ...
                        <svg className="textcircle" viewBox="0 0 500 500">
                          ...
                          <text>
                            <textPath xlinkHref="#textcircle" textLength={900}>
                              find the dream home Earlybird Properties real estate *
                            </textPath>
                          </text>
                        </svg>
                      </div>
